...
const ContactDetails = () => {
  ...
  return (
    <div className="flex flex-col gap-6 md:gap-10 text-black text-base md:text-lg p-4">
      <div className="flex flex-col mx-auto gap-4 md:text-lg bg-slate-50 rounded-xl px-4 py-3 md:py-4 md:px-8 justify-between items-center w-full md:w-3/4 max-w-3xl shadow-lg shadow-slate-600">
        ...
        <div className="flex gap-6 items-center justify-center">
          <button
            ...
            className="bg-yellow-400 text-sm md:text-base px-3 py-2 md:px-4 md:py-2 rounded-xl shadow-lg hover:bg-yellow-300"
          >
            Edit
          </button>
          <button
