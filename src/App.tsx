...
function App() {
  return (
    <div className="flex gap-1 py-3 px-1 md:gap-2 max-w-7xl mx-auto min-h-screen">
      {/* Side Bar (Menu) */}
      <div className="flex-none w-1/5 bg-slate-200 max-h-screen rounded-xl">
        <div className="px-0 py-3 gap-6 mx-1 flex flex-col text-slate-900 md:text-xl sm:p-4 lg:p-8 md:gap-12">
          ...
          <nav className="flex flex-col gap-4 lg:gap-8">
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? 'text-sky-600 font-bold mr-auto'
      ...
      <div className="flex-initial w-4/5 bg-orange-200 rounded-xl">
